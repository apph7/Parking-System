            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd><a href="<%=request.getContextPath()%>/admin">退出</a></dd>
                    </dl>
                </li>
                <!--这里-->
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu"
                    ...
                    <li data-name="component" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd>
                                <a lay-href="<%=request.getContextPath()%>/parking_spot">
                                    <i class="layui-icon layui-icon-list"></i>
                                    停车位</a>
                            </dd>
                            <dd>
                                <a lay-href="<%=request.getContextPath()%>/parking_record">
                                    <i class="layui-icon layui-icon-survey"></i>
                                    停车记录</a>
                            </dd>
                        </dl>
                    ...
                    <li data-name="component" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                <a lay-href="<%=request.getContextPath()%>/payment">
                    ...
                    <li data-name="app" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="carousel">
                                <a lay-href="<%=request.getContextPath()%>/vehicles">
                                    <i class="layui-icon layui-icon-engine"></i>
                                    车辆信息</a>
                            </dd>
                        </dl>
                    ...
                    <li data-name="user" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a lay-href="<%=request.getContextPath()%>/user_info">
                    ...
                    <li data-name="app" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        <a lay-href="<%=request.getContextPath()%>/admin/log/index" lay-tips="日志" lay-direction="2">
                    ...
                    <li data-name="app" class="layui-nav-item"> <!-- 不添加 layui-nav-itemed 类 -->
                        <a lay-href="<%=request.getContextPath()%>/admin/visitor/index" lay-tips="访问" lay-direction="2">
